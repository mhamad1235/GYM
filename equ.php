    ...
    <div class="row">
        <div class="col-md-3">
            ...
            <li></li>
                ...
                <li  id="oo"><a><i class="fa fa-pencil fa-fw"></i>font</a> <button class="sub" onclick="A()">A+</button> <button class="sub"  onclick="d()">A</button> <button class="sub"  onclick="a()">-A</button></li> 
                <li  id="ooo"><a><i class="fa fa-pencil fa-fw"></i>Them</a> <button class="sub" onclick="dark()">Dark mode</button></li> 
...
<a style="text-decoration:none;" href="addQ.php"><button class="subb">Add Equipment</button></a><br>
...
while ($row=mysqli_fetch_assoc($result)) {
    ...
    <td>  <a style="text-decoration:none;" href="deletq.php? eq='.$id.'"><button class="subb">Delete</button></a>
