...
<a style="text-decoration:none;" href="add.php"><button class="subb">Add player</button></a><br>
...
while ($row=mysqli_fetch_assoc($result)) {
    ...
    <td>'.$gender.'</td>
    <td>'.$date.'</td>
    <td>  <a style="text-decoration:none;" href="delet.php? deletid='.$id.'"><button class="subb">Delete</button></a>
    <a style="text-decoration:none;" href="aupdate.php? deletid='.$id.'"><button class="subb">Update</button></a>
    </td>
  </tr>';
}
