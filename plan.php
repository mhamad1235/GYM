...
<div style="overflow:auto;" class="mhamad">
    <a href="addplan.php"><button class="sub">Add plan</button></a>
<br> <br>
...
while ($row=mysqli_fetch_assoc($result)) {
    ...
    <th scope="row">'.$id.'</th>
    <td>'.$plan.'</td>
    <td><a style="text-decoration:none;"href="delete.php? deletid='.$id.'"><button  class="subb">Delete</button></a></td>
  </tr>';
}
