...
<table class="styled-table">
  ...
  while ($row=mysqli_fetch_assoc($result)) {
      ...
      <td>  <a style="text-decoration:none;" href="deney.php? deletid='.$id.'"><button class="subb">Deney</button></a>
      <a style="text-decoration:none;" href="approve.php? deletid='.$id.'"><button onclick="app()" class="subb">Approve</button></a>
      </td>
    </tr>';
  }
  ...
  <a href="deney.php? reg='<?php echo $idd ?>'">A </a>
  <a href="approve.php? reg='<?php echo $idd ?>'">A </a>
